...
const OnboardingFormOwn = ({ existingSession }: Props) => {
  ...
  const saveProgress = async (data: Partial<FormData>, shouldNavigate: boolean = false, complete: boolean = false) => {
    try {
      // Determine email to use: from form or current session
      ...
      // Always use backend function to create/find user and persist session
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input id="vehicle_make" {...register("vehicle_make")} placeholder="e.g., Toyota" />
                  {errors.vehicle_make && <p className="text-sm text-destructive">{errors.vehicle_make.message}</p>}
                </div>
                <div>
                  <Label htmlFor="vehicle_model">Model</Label>
                  <Input id="vehicle_model" {...register("vehicle_model")} placeholder="e.g., Corolla" />
                  {errors.vehicle_model && <p className="text-sm text-destructive">{errors.vehicle_model.message}</p>}
                </div>
                <div>
                  <Label htmlFor="vehicle_year">Year</Label>
                  <Input id="vehicle_year" {...register("vehicle_year")} placeholder="e.g., 2020" />
                ...
                <div>
                  ...
                  <Input id="vehicle_registration" {...register("vehicle_registration")} />
