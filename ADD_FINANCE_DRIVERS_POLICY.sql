...
-- Create policy for finance users to view active drivers (active = true OR active IS NULL)
-- Using same pattern as admin_read_all_drivers to avoid recursion issues
